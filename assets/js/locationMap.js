        ...
        try {
            ...
            geocoder.geocode({ 'address': $(_this).attr("address") }, function (results, status) {
                if (status == google.maps.GeocoderStatus.OK) {
                    ...
                    var image = '../wp-content/themes/therealburger/assets/images/cd-icon-location.png';
...
function NearestCity(latitude, longitude) {
    ...
    //$('#map-' + cities[closest][0]).next().attr('src', "../wp-content/themes/therealburger/assets/images/select-map.png");
